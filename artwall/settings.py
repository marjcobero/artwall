"""
Django settings for artwall project.
...
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'artist_admin'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
DEFAULT_EMAIL_FROM = 'ArtWall <noreply@artwall.com>'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.artwork.context_processors.menu_categories',
...
WSGI_APPLICATION = 'artwall.wsgi.application'
